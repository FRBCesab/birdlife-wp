...
[![Static Badge](https://img.shields.io/badge/Repo_status-Active-blue)](https://www.repostatus.org/#active)
...
| :--------------------------------------------- | :------------------------------------------- | :---------------------------- | :----: |
| WWF Terrestrial Ecoregions of the World        | Create Western Palearctic region | Olson _et al._ (2001)         | [link](https://www.worldwildlife.org/publications/terrestrial-ecoregions-of-the-world) |
...
Launch the [`make.R`](https://github.com/frbcesab/birdlife-wp/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/frbcesab/birdlife-wp/blob/main/CONTRIBUTING.md).
...
that aims to model and project the impacts of the anthropocene on soundscapes with birds as an acoustic ecological indicator.
...
Olson DM, Dinerstein E, Wikramanayake ED _et al._ (2001) Terrestrial ecoregions of the World: A new map of life on Earth. **Bioscience**, 51, 933-938. DOI: [10.1641/0006-3568(2001)051[0933:TEOTWA]2.0.CO;2](https://doi.org/10.1641/0006-3568(2001)051[0933:TEOTWA]2.0.CO;2).
